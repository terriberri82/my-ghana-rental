...
function Icon({ name }) {
  const paths = {
    ...
    building: "M3 21h18M5 21V5a2 2 0 012-2h10a2 2 0 012 2v16M9 7h2M13 7h2M9 11h2M13 11h2M9 15h2M13 15h2",
...
export default function Sidebar() {
  ...
  return (
    <aside className="bg-bayou w-16 md:w-56 shrink-0 flex flex-col">
      <div className="h-20 flex items-center gap-3 px-3 md:px-5">
